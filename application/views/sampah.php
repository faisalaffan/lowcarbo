...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<table class="table table-striped table-bordered" id="dataSampah">
					<thead>
						<tr>
							<th>TITLE</th>
							<th>JENIS SAMPAH</th>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="nama_jenis_sampah" aria-describedby="nama_jenis_sampah"
						placeholder="Enter email" disabled>
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Milik Tps</label>
					<input type="text" class="form-control" id="nama_tps" aria-describedby="nama_tps"
						placeholder="Enter email" disabled>
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Latitude Sampah</label>
					<input type="text" class="form-control" id="lat" aria-describedby="lat"
						placeholder="Enter email" disabled>
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Longitude Sampah</label>
					<input type="text" class="form-control" id="lng" aria-describedby="lng"
						placeholder="Enter email" disabled>
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Title Sampah</label>
					<input type="text" class="form-control" id="title" aria-describedby="title"
						placeholder="Enter email" disabled>
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Berat Sampah</label>
					<input type="text" class="form-control" id="berat" aria-describedby="berat"
						placeholder="Enter email" disabled>
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Tertampung</label>
					<input type="text" class="form-control" id="tertampung" aria-describedby="tertampung"
						placeholder="Enter email" disabled>
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Created At</label>
					<input type="text" class="form-control" id="waktu_ditambahkan" aria-describedby="waktu_ditambahkan"
						placeholder="Enter email" disabled>
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Gambar Sampah</label><br>
					<img src="" alt="" srcset="" id="gambar" height="100vh" class="img-thumbnail">
				</div>
			</div>
...
<script>
	...
	$(document).ready(function () {
		...
		$('#dataSampah tbody').on('click', 'td button#buttonDetail', function () {
			var data = $table.row($(this).parents('tr')).data();
			$("#modalDetail").modal();
			$("#modalDetail input#nama_jenis_sampah").val(data.nama_jenis_sampah);
			$("#modalDetail input#nama_tps").val(data.nama_tps);
			$("#modalDetail input#lat").val(data.lat);
			$("#modalDetail input#lng").val(data.lng);
			$("#modalDetail input#title").val(data.title);
			$("#modalDetail input#berat").val(data.berat);
			$("#modalDetail input#tertampung").val(data.tertampung);
			$("#modalDetail input#waktu_ditambahkan").val(data.waktu_ditambahkan);
			$("#modalDetail img#gambar").attr("src", "<?= base_url('assets/') ?>" + data.gambar);
		});

		$('#dataSampah tbody').on('click', 'td button#buttonEdit', function () {
			var data = $table.row($(this).parents('tr')).data();
			$("#modalEdit").modal();
		...
		$('#dataSampah tbody').on('click', 'td button#buttonHapus', function () {
			var data = $table.row($(this).parents('tr')).data();
