  ...
  -->
	...
	<page id="home">
		...
		<section id="grid_wrapper" class="init">
			...
			<card>
				<div onclick="window.location.href='<?= base_url('auth'); ?>'">
					<span>LOGIN</span>
				</div>
			</card>
		</section>
	...
	<div id="footer">
		<span style="display:block;font-size:0.9em;line-height:55px;"><span style="display:inline-block;">&copy; <span
					style="font-family:'Titillium Web';font-weight:900;letter-spacing:0.06em">WASUK</span> Design
				2019</span></span>
		<span
			style="display:block;font-size:0.7em;line-height:30px;margin-top:-25px;color:rgba(255,255,255,0.15)">&lang;
			-- Stay Premium -- &rang;<span>
	</div>
